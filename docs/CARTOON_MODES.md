...
| `block_drop` | Koop ohne Timer auf 5×8 Raster. Drei zusammenhängende Farbbögen steuern links/drehen/rechts. SBull senkt eine Zeile, DBull setzt sofort und gibt +25; Miss macht nichts. Erst nachdem alle Spieler dran waren, fällt der Stein automatisch eine Zeile. Fünf Linien gewinnen, Top-out verliert; Blockpunkte zählen für alle. |
