...
| `space_defender` | Koop mit gemeinsamem Score: exakte Schiffe, Ringmultiplikator entspricht Schaden, Bull trifft alle. Abschusspunkte erhalten alle Teammitglieder. Bei zehn aktiven Schiffen verliert das Team. Nach der letzten Welle gibt es genau eine Aufräumrunde. Erfolgreiches Team: +3 für alle. |
