...
- Rust-Workspace mit Contracts, FFF1-Protokoll, CountUp-, X01-, Cricket-,
  8-Ball-, Heart-Chase- und Target-Rush-Kern, atomarer Runtime und
  SQLite-Repository,
...
- statische, zur Buildzeit typsicher registrierte Spielmodi mit versionierten
  ...
  8-Ball, Heart Chase und Target Rush. Cricket, 8-Ball, Heart Chase und Target
  Rush laufen über denselben generischen Registry-Pfad und sind durch gemeinsame
...
- Öffentliche Commands zum Korrigieren und Löschen über stabile Action-IDs für
  CountUp, X01 und alle Registry-Modi, derzeit Cricket, 8-Ball, Heart Chase und
  Target Rush. Der gemeinsame State liefert die editierbaren Darts der aktuellen
  und vorherigen Aufnahme. Replay,
