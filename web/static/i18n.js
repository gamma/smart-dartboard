(function(){
  ...
  const ui = {
    de: {
      ...
      individual_play:'Einzeln',
      two_teams:'2 Teams',
      team_setup_copy:'Optional zwei feste Teams für Teammodi zusammenstellen.',
      team_assignment_help:'Spieler antippen, um sie mit einem Klick ins andere Team zu verschieben.',
      move_to_other_team:'Ins andere Team verschieben',
      team_needs_player:'Noch ohne Spieler',
      teams_need_split:'Beide Teams brauchen mindestens einen Spieler.',
      maximum_players:'Maximal acht Spieler pro Session.',
      ...
      settings_unavailable_calibration:'Während der Kalibrierung nicht verfügbar',
      settings_kicker:'ARCADE-SETUP',
      settings_copy:'Ton, Darstellung und Board-Setup ändern, ohne die Session oder das laufende Spiel zu beenden.',
      settings_saved_immediately:'Änderungen werden sofort gespeichert.',
      board_setup:'BOARD-SETUP',
      calibrate_settings_copy:'Die Projektion wird vorübergehend zur Kalibrieransicht umgeschaltet. Danach kehrt ihr genau hierher zurück.',
      ...
      selected_rules:'GEWÄHLTE REGELN',
      ...
      coop_mode:'KOOP',
      team_mode:'TEAMMODUS',
      one_coop_team:'ALLE SPIELEN IN EINEM TEAM',
      ...
      diagnostic_export_title:'Diagnosepaket',
      diagnostic_export_copy:'Exportiert Health, Versionen, Konfiguration und redigierte Logs. Spielernamen, Tokens, BLE-Rohdaten und die Datenbank bleiben draußen.',
      diagnostic_export:'Diagnose exportieren',
      ...
      game_sound:'SPIEL-SOUND',
      playback_on:'Ausgabe auf',
      sound_output:'SOUNDAUSGABE',
      sound_output_controller:'Controller',
      sound_output_projector:'Projektor',
      sound_output_both:'Beide',
      sound_output_help:'Controller eignet sich, wenn am Projektor kein Lautsprecher angeschlossen ist.',
      ...
      test_tone:'Testton',
      autoplay_help:'Der gewählte Browser blockiert Autoplay. Testton antippen oder im Kioskmodus die Autoplay-Freigabe aktivieren.',
    ...
    en: {
      ...
      two_teams:'2 teams',
      team_setup_copy:'Optionally arrange two fixed sides for team modes.',
      team_assignment_help:'Tap a player to move them to the other team in one click.',
      move_to_other_team:'Move to the other team',
      team_needs_player:'No player yet',
      teams_need_split:'Both teams need at least one player.',
      maximum_players:'A session supports up to eight players.',
      ...
      settings:'Settings',
      settings_unavailable_calibration:'Unavailable during calibration',
      settings_kicker:'ARCADE SETUP',
      settings_copy:'Change sound, visuals, and board setup without ending the session or current game.',
      settings_saved_immediately:'Changes are saved immediately.',
      board_setup:'BOARD SETUP',
      calibrate_settings_copy:'The projection temporarily switches to calibration and then returns you right here.',
      ...
      coop_mode:'CO-OP',
      team_mode:'TEAM MODE',
      one_coop_team:'EVERYONE PLAYS AS ONE TEAM',
      configured_teams:'TEAMS',
      ...
      diagnostic_export_title:'Diagnostic bundle',
      diagnostic_export_copy:'Exports health, versions, configuration and redacted logs. Player names, tokens, raw BLE data and the database stay out.',
      ...
      playback_on:'Playback on',
      sound_output:'SOUND OUTPUT',
      sound_output_controller:'Controller',
      sound_output_projector:'Projector',
      sound_output_both:'Both',
      sound_output_help:'Choose Controller when the projector has no connected speaker.',
      enabled:'Enabled',
      disabled:'Disabled',
      status:'Status',
      ...
      test_tone:'Test tone',
      autoplay_help:'The selected browser blocked autoplay. Tap Test tone or enable autoplay in kiosk mode.',
      session_setup:'SESSION SETUP',
