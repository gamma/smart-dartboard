(function(){
  ...
  const ui = {
    de: {
      ...
      data_archive:'DATENARCHIV',
      data_import_title:'Spielhistorie importieren',
      data_import_copy:'Importiert ein zuvor exportiertes JSON-Archiv atomar. Bestehende Sessions und Spiele werden nie überschrieben; laufende Einträge werden sicher als unterbrochen archiviert.',
      import_data:'JSON importieren',
      import_confirm:'Dieses Archiv zur lokalen Historie hinzufügen? Der Import überschreibt keine vorhandenen Sessions oder Spiele.',
      import_success:'Import fertig: {players} Spieler, {sessions} Sessions und {games} Spiele hinzugefügt.',
      import_too_large:'Das Archiv ist größer als 16 MiB.',
      ...
      board_connecting:'BOARD WIRD VERBUNDEN',
      board_disconnected:'BOARD GETRENNT',
      board_bluetooth_off:'BLUETOOTH IST AUS',
      board_permission_required:'BLUETOOTH-FREIGABE FEHLT',
      board_unavailable:'BOARD NICHT VERFÜGBAR',
      controls:'STEUERUNG',
      top_left:'Oben links',
    ...
    en: {
      ...
      data_import_title:'Import game history',
      data_import_copy:'Atomically imports a previously exported JSON archive. Existing sessions and games are never overwritten; running records are safely archived as interrupted.',
      import_data:'Import JSON',
      import_confirm:'Add this archive to local history? The import will not overwrite existing sessions or games.',
      import_success:'Import complete: {players} players, {sessions} sessions and {games} games added.',
      import_too_large:'The archive is larger than 16 MiB.',
      ...
      board_connecting:'CONNECTING BOARD',
      board_disconnected:'BOARD DISCONNECTED',
      board_bluetooth_off:'BLUETOOTH IS OFF',
      board_permission_required:'BLUETOOTH PERMISSION REQUIRED',
